...
class ControllerExceptionHandler {
    ...
    public ResponseEntity<?> globalException(Exception e) {
        ...
        return returnByApiResponse(new ApiResponse("서버 에러", ResponseCode.CODE_0500));
    }
    ...
    public ResponseEntity<?> runTimeException(RuntimeException e) {
        log.error(ExceptionUtils.getStackTrace(e));
        return returnByApiResponse(new ApiResponse("런타임 에러", ResponseCode.CODE_0500));
    }
    ...
    public ResponseEntity<?> FileModuleException(FileModuleException e) {
        log.error(ExceptionUtils.getStackTrace(e));
        return returnByApiResponse(new ApiResponse(e.getMessage(), ResponseCode.CODE_0400));
    }
    ...
    public ResponseEntity<?> FileNotFoundException(FileNotFoundException e) {
        log.error(ExceptionUtils.getStackTrace(e));
        return returnByApiResponse(new ApiResponse("파일 탐색 실패", ResponseCode.CODE_0500));
    }
    ...
    public ResponseEntity<?> maxUploadSizeExceededException(MaxUploadSizeExceededException e) {
        log.error(ExceptionUtils.getStackTrace(e));
        return returnByApiResponse(new ApiResponse("업로드 용량 초과", ResponseCode.CODE_0500));
    }
    ...
    public ResponseEntity<?> methodArgumentNotValidException(MethodArgumentNotValidException e){
        ...
        return returnByApiResponse(new ApiResponse(String.join(", ", messageList), ResponseCode.CODE_0400));
    }
    ...
    public ResponseEntity<?> httpRequestMethodNotSupportedException(MissingServletRequestPartException e) {
        log.error(ExceptionUtils.getStackTrace(e));
        return returnByApiResponse(new ApiResponse("첨부파일 누락", ResponseCode.CODE_0400));
    }
    ...
    public ResponseEntity<?> httpRequestMethodNotSupportedException(HttpRequestMethodNotSupportedException e) {
        log.error(ExceptionUtils.getStackTrace(e));
        return returnByApiResponse(new ApiResponse("잘못된 접근", ResponseCode.CODE_0403));
    }
    ...
    public ResponseEntity<?> HttpMessageConversionException(HttpMessageConversionException e) {
        log.error(ExceptionUtils.getStackTrace(e));
        return returnByApiResponse(new ApiResponse("잘못된 요청", ResponseCode.CODE_0400));
    }
    ...
    public ResponseEntity<?> ExecutionException(ExecutionException e) {
        log.error(ExceptionUtils.getStackTrace(e));
        return returnByApiResponse(new ApiResponse("빌드 에러", ResponseCode.CODE_0500));
    }
    ...
    public ResponseEntity<?> JsonParseException(JsonParseException e) {
        log.error(ExceptionUtils.getStackTrace(e));
        return returnByApiResponse(new ApiResponse("JSON 파싱 에러", ResponseCode.CODE_0500));
    }
